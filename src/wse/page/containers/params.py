...
from wse.page.widgets.box import BoxFlexCol, BoxFlexRow
from wse.page.widgets.box_page import BaseBox, WidgetMixin
from wse.page.widgets.button import BtnApp
from wse.page.widgets.label import LabelParam, TitleLabel
from wse.page.widgets.number_input import NumberInputApp
from wse.page.widgets.switch import SwitchApp
